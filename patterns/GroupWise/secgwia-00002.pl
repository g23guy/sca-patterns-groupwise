...
# Title:       GroupWise GWIA Security Alert 478892
# Description: GroupWise GWIA vulnerability that could lead to arbitrary code execution with SYSTEM privileges from the way it processes certain SMTP requests.
...
@PATTERN_RESULTS = (
	...
	"META_LINK_TID=http://www.suse.com/support/kb/doc.php?id=7003272",
	"META_LINK_BUG=https://bugzilla.novell.com/show_bug.cgi?id=478892"
);
